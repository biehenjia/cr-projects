...
CRobj* CRsum::addto(const CRobj& target) const { 
    return target.add(*this);
}

CRobj* CRsum::multo(const CRobj& target) const { 
    return target.mul(*this);
}

CRobj* CRsum::powto(const CRobj& target) const { 
    return target.rpow(*this);
}

CRobj* CRsum::rpow(const CRobj& target) const { 
