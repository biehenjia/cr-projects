...
CRobj* CRprod::addto(const CRobj& target) const { 
    return target.add(*this);
}

CRobj* CRprod::multo(const CRobj& target) const { 
    return target.mul(*this);
}

CRobj* CRprod::powto(const CRobj& target) const { 
    return target.rpow(*this);
}

CRobj* CRprod::rpow(const CRobj& target) const { 
